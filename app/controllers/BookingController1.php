 ...
 *
 */
class BookingController1 extends BaseController
{
    /**
     * @return void
     */
...
// File: app/controllers/BookingController.php
    ...
    {
        // Validate and gather booking data
        $bookingData = $request->only(['customer_id', 'check_in', 'check_out', 'total_price']);

        // Create a new booking
        $booking = Booking::create($bookingData);

        // Gather room allocation details
        $roomAllocations = $request->input('rooms'); // Assume this is an array of room details

        // Insert room allocation details into booking_details table
        foreach ($roomAllocations as $room) {
